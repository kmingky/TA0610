...
class Product(models.Model):
    ...
    category = models.ForeignKey(Category, on_delete=models.CASCADE, verbose_name="상품구분")
    image = models.ImageField(upload_to='product_img', verbose_name="상품사진")
    description = models.TextField(verbose_name="상품설명")
    price = models.IntegerField(verbose_name="상품가격")
    stock = models.IntegerField(verbose_name="재고")
    productorder = models.ForeignKey(ProductOrder, on_delete=models.CASCADE, verbose_name="주문수량")
...
class UserOrder(models.Model):
    ...
    order_date = models.DateTimeField(auto_now=True, auto_now_add=False, verbose_name="주문시간")
    ...
    orderstatus = models.ForeignKey(OrderStatus, on_delete=models.CASCADE, verbose_name="주문상태")
